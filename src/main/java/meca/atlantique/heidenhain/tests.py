...
test_read_pgm_status(IP, TIMEOUT)
test_read_pgm_stack(IP, TIMEOUT)
test_read_execution_state(IP, TIMEOUT)
test_read_tool_information(IP, TIMEOUT)
test_read_override_information(IP, TIMEOUT)
test_read_error_messages(IP, TIMEOUT)
test_read_axes_location(IP, TIMEOUT)